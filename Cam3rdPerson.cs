...
public class Cam3rdPerson : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        TheCamera.position = new Vector3(Parent.transform.position.x, Parent.transform.position.y + hightOffset, Parent.transform.position.z) + Quaternion.Slerp(transform.localRotation, targetRotation, 0.1f) * dir;

...
{
    public class CustomNatMatchMakingLobby : NATTraversal.NetworkManager
    {
        ...
        int m_MinPlayers;
        [SerializeField]
        CustomNatLobbyPlayer m_LobbyPlayerPrefab;
        [SerializeField]
        ...
        Text LobbyTimerText;
        [SerializeField]
        bool StartLobbyTimer;
        
        // runtime data
        List<PendingPlayer> m_PendingPlayers = new List<PendingPlayer>();
        public CustomNatLobbyPlayer[] lobbySlots;
        ...
        public CustomNatLobbyPlayer lobbyPlayerPrefab { get { return m_LobbyPlayerPrefab; } set { m_LobbyPlayerPrefab = value; } }
        ...
        {
            var lobbyPlayer = lobbyPlayerGameObject.GetComponent<CustomNatLobbyPlayer>();
            if (lobbyPlayer == null)
            {
        ...
        static int CheckConnectionIsReadyToBegin(NetworkConnection conn)
        {
            ...
            for (int i = 0; i < conn.playerControllers.Count; i++)
            {
                ...
                if (player.IsValid)
                {
                    var lobbyPlayer = player.gameObject.GetComponent<CustomNatLobbyPlayer>();
        ...
        public void CheckReadyToBegin()
        {
            ...
            if (loadedSceneName != m_LobbyScene)
            {
                Debug.Log("loadedSceneName != m_LobbyScene");
                return;
            }
            ...
            {
              //  Debug.Log("not enough players ready yet.");
        ...
        public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
        {
            ...
            var newLobbyPlayer = newLobbyGameObject.GetComponent<CustomNatLobbyPlayer>();
        ...
        public override void OnServerRemovePlayer(NetworkConnection conn, PlayerController player)
        {
            ...
            byte slot = player.gameObject.GetComponent<CustomNatLobbyPlayer>().slot;
            ...
            for (int i = 0; i < lobbySlots.Length; i++)
            {
                ...
                if (lobbyPlayer != null)
                {
                    lobbyPlayer.GetComponent<CustomNatLobbyPlayer>().readyToBegin = false;
        ...
        void OnServerReadyToBeginMessage(NetworkMessage netMsg)
        {
            ...
            var lobbyPlayer = lobbyController.gameObject.GetComponent<CustomNatLobbyPlayer>();
        ...
        public override void OnStartServer()
        {
            ...
            {
                lobbySlots = new CustomNatLobbyPlayer[maxPlayers];
            }
        ...
        private void Update()
        {
            ...
            if (StartLobbyTimer)
            {
                ...
                LobbyTimer = LobbyTimer - 1 * Time.deltaTime;
                if (LobbyTimerText != null)
                {
                    LobbyTimerText.text = (int)LobbyTimer + "";
                }
               
              //  Debug.Log("LobbyTimer: " + LobbyTimer);
                if (LobbyTimer <= 0)
                {
                    ...
                    LobbyTimer = 4;
                    StartLobbyTimer = false;
                }
            }
            else {
                string oldText = "Ready";
                LobbyTimerText.text = oldText;
               LobbyTimer = 4;
            }
            //NetworkMessage blah = "fasdf" as NetworkMessage;
            // OnServerReadyToBeginMessage(blah);
        }
...
namespace NATTraversal
{
    public class CustomNatMatchMatchMakingLobby : NATTraversal.NetworkManager
    {
        struct PendingPlayer
        {
            public NetworkConnection conn;
        ...
        public override void OnServerRemovePlayer(NetworkConnection conn, PlayerController player)
        {
            ...
            foreach (var p in lobbySlots)
            {
                if (p != null)
                {
                    p.GetComponent<CustomNatLobbyPlayer>().readyToBegin = false;
